...
public class Ambiance_Toggle : Control
{
    ...
    protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
    {
        ...
        if (_Toggled == true)
        {
            G.DrawPath(new Pen(Color.FromArgb(89, 169, 222)), SwitchPath);
            G.DrawPath(new Pen(Color.FromArgb(89, 169, 222)), ControlPath);
        }
        else
        {
...
class CheckBox : Control
{
    ...
    public delegate void CheckedChangedEventHandler(object sender, EventArgs a);
    ...
    protected override void OnResize(System.EventArgs e)
    {
        if (Width > 0 && Height > 0)
        {
            ...
            GB = new LinearGradientBrush(new Rectangle(0, 0, 25, 25), Color.FromArgb(1, 1, 1), Color.FromArgb(89, 169, 222), 90); //Innen
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        MyDrawer.DrawPath(new Pen(Color.FromArgb(89, 169, 222)), Shape); //Rand
        // Draw the border
...
public class Ambiance_ListBox : ListBox
{
    ...
    public Ambiance_ListBox()
    {
        ...
        ItemHeight = 16;
        Font = new Font("Seoge UI", 10, FontStyle.Regular);
    }
