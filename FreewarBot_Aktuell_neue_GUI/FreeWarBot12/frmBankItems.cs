...
{
    public partial class frmBankItems : Form
    {
        List<string> _SellItems = new List<string>();
        public frmBankItems(List<string> sellitems)
        {
        ...
        private void Save()
        {
            StreamWriter myFile1 = new StreamWriter(Application.StartupPath + "\\ItemstoBank.txt", false, System.Text.Encoding.Default);
            for (int i = 0; i < _SellItems.Count; i++)
            {
